...
Write-Host "===== AppMaker ====="
Write-Host " "
promptMessage "Please wait while creating the MSI..." "warning"
...
LogWrite "Writing MSI template - $folderLoc\$($applicationName)_$($applicationVersion).aip"

# Wrap the EXE
LogWrite "Creating MSI file"
...
if(Test-Path "$folderLoc\$($applicationName)_$($applicationVersion).msi"){
	...
	LogWrite "Moving MSI to output folders"
